...
export function withMessageReactions<T extends object>(
    message: T,
...
export async function getChannelReactionMap(messageIds: string[]): Promise<Map<string, MessageReactionSummary[]>> {
